namespace TechTreeEditor
{
	partial class EditBuildingForm
	{
		...
		private void InitializeComponent()
		{
			...
			this._buttonIDField = new TechTreeEditor.Controls.NumberFieldControl();
            ...
            0,
            0});
			this._buttonIDField.ValueChanged += new TechTreeEditor.Controls.NumberFieldControl.ValueChangedEventHandler(this._buttonIDField_ValueChanged);
			// 
			// EditBuildingForm
			// 
